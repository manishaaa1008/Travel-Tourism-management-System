...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run() {
        String[] text = new String[] {"Marriott Hotel", "Oberoy Hotel", "Four Seasons Hotel", "Raddision Blue Hotel", "Classio Hotel", "The Bay Club Hotel", "Breeze Blow Hotel", "The taj Hotel", "Happy Morning Hotel", "River View Hotel"};
        try {
            for(int i = 0; i<= 9; i++) {
